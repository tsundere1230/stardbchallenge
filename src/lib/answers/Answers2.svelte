...
<p  class = "answerkey"><br>
    There are {@html math("[40]")} or {@html math("[41]")} characters, depending if you include Dr. Ratio (but it doesn't matter).<br>
    There are 23 teleport points in Herta's Space Station.<br>
    Maximum Trailblaze Power is {@html math("[240]")} . <br>
    The EXP requirement to go from Level 64 to 65 is {@html math("[26630]")} . The cube root of that is approximately {@html math("[30]")} . <br>
    Therefore, the Radius rounds to {@html math("65")} and the Angle rounds to {@html math("270")} .
</p>
...
<p class = "answerkey"><br>
    The only way to measure distances in game is to attempt to 'navigate' to a place of interest,
    in this case Maozhen's shop.
</p>
