...
const hints = [
    [
        ...
        { r: /^08ruanmeijpult(imate)?$/i, s: "[g] tsun: Hi! I thought I might give you a hint! There are two words in the final answer, and the first is at least double the length of the second! *tsun disappears back to bilibili to watch cosplay videos*" },
