...
const hints = [
    [
        ...
        { r: /^13topaz(&numby)?jpbasic(attack)?$/i, s: "Numby thinks Dr Ratio is funny and tries the [l] symbol with its toes(?). Too bad they're too short to actually make the l" }, 
